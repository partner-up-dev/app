...
export type ShareSpmRouteKey = "home" | "pr-create" | "pr" | "contact_support" | "contact_author";

export type ShareSpmMethodKey = "web_share" | "wechat_share" | "xiaohongshu";
...
export const sanitizeSpmValue = (value: string | null | undefined): string | null => {
...
export const resolveSpmFromUrl = (rawUrl: string, baseHref: string): string | null => {
...
export const buildProductShareUrl = ({
  ...
  parsed.searchParams.set(SPM_QUERY_PARAM, buildProductShareSpm(routeKey, methodKey));
  return parsed.toString();
};

...
const toPRCoordinate = (
  coordinate: RoutePoint["gcj02"],
): PRRoutePoint["gcj02"] =>
...
export const fromPRRoute = (
  route: PRRoute | null | undefined,
): Route | null => cloneRoute(route);

export const createEmptyPRRouteDraft = (): PRRoute =>
  createEmptyRouteDraft().map(toPRRoutePoint);
...
export const normalizePRRouteForSubmit = (
  route: PRRoute | null | undefined,
): PRRoute | null => toPRRoute(normalizeRouteForSubmit(route));

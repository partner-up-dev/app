...
| File | Local Component | Package Target | Status |
| --- | --- | --- | --- |
| `components/modal.md` | `shared/ui/overlay/Modal.vue` | `PuModal` | Proposed |
| `components/confirm-dialog.md` | `shared/ui/overlay/ConfirmDialog.vue` | `PuDialog` or `PuModal` + `PuButton` | Proposed |
| `components/bottom-drawer.md` | `shared/ui/overlay/BottomDrawer.vue` | `PuDrawer` | Proposed |

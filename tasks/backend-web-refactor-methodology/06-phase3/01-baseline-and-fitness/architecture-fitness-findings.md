...
| --- | ---: | ---: | --- |
| `backend/no-canonical-pr-to-pr-core` | 50 | 0 | `3-5` compatibility retirement; includes imports and compatibility re-exports |
...
| `web/no-model-to-query` | 9 | 0 | Owning Web domain migration; PR contract edges feed `3-6` |
| `web/no-model-to-transport` | 3 | 0 | `3-6` moves inference to an adapter-owned contract seam |
